...
<html lang="en" class="no-js">
	<head>
		...
		<title>Travelogue | Contact Page</title>
	...
	<body class="index-contact">
		...
		<!-- EOF: Fancy Search Form (content imported via jQuery: from search-form.html) -->
			...
			<header class="header">
				<div class="bg-img">
					<img class="async-image hide" src="" data-src="img/2.jpg" alt="" />
				...
				<div class="title">
					...
					<p class="subline">Dejanos tu comentario</p>

					<div>
						<form id="theForm" class="simform" autocomplete="off" method="POST" action="php/contact_mail.php">
							<div class="simform-inner">
								<ol class="questions">
									<li>
										<span><label for="q1">Cual es tu nombre?</label></span>
										<input id="q1" class="focus-me" name="q1" type="text"/>
									</li>
									<li>
										<span><label for="q2">Cual es tu e-mail?</label></span>
										<input id="q2" class="focus-me" name="q2" type="text"/>
									</li>
									<li>
										<span><label for="q3">De que nos queires hablar?</label></span>
										<input id="q3" class="focus-me" name="q3" type="text"/>
									</li>
									<li>
										<span><label for="q4">Puedes decirnos mas?</label></span>
										<textarea id="q4" name="q4" class="focus-me"></textarea>
									</li>
								</ol><!-- /questions -->
								<button class="submit" name="submit_contact" type="submit">Enviar información</button>
								<div class="controls">
